...
1. [Input Processor](#input-processor)
1. [Token Processor](#token-processor)
   1. [Scanning for Tokens](#scanning-for-tokens)
1. [Expand Processor](#expand-processor)
   1. [How Macros Are Defined](#how-macros-are-defined)
   1. [How Macros Are Expanded](#how-macros-are-expanded)
   1. [How Conditionals Are Processed](#how-conditionals-are-processed)
   1. [Summary of What Is Not Expanded](#summary-of-what-is-not-expanded)
   1. [Expand Processor's Registers and Primitives](#expand-processors-registers-and-primitives)
1. [Main Processor](#main-processor)
   1. [Main Processor's Modes](#main-processors-modes)
   1. [Handling the Commands](#handling-the-commands)
   1. [Registers and Data Types](#registers-and-data-types)
      1. [Numeric Constants](#numeric-constants)
   ...
   1. [Fonts](#fonts)
   1. [Boxes](#boxes)
      1. [How a Horizontal Box Is Assembled](#how-a-horizontal-box-is-assembled)
      1. [How a Vertical Box Is Assembled](#how-a-vertical-box-is-assembled)
   1. [Spaces](#spaces)
      1. [How Spaces Are Inserted to the Horizontal List](#how-spaces-are-inserted-to-the-horizontal-list)
      1. [How Spaces Are Inserted to the Vertical List](#how-spaces-are-inserted-to-the-vertical-list)
   1. [Specifying Fill Pattern with `\leaders`](#specifying-fill-pattern-with-leaders)
   1. [`\halign`, `\valign`](#halign-valign)
   1. [Entering/Leaving the Math Mode or Display Mode](#enteringleaving-the-math-mode-or-display-mode)
   1. [Building a Math List](#building-a-math-list)
   1. [Converting a Math List to the Horizontal List](#converting-a-math-list-to-the-horizontal-list)
      1. [Fonts and Styles](#fonts-and-styles)
      1. [Auxiliary Algorithms](#auxiliary-algorithms)
      1. [The Conversion](#the-conversion)
   1. [Breaking Terminology](#breaking-terminology)
   1. [`\discretionary` Breakpoints](#discretionary-breakpoints)
   1. [Hyphenation](#hyphenation)
      1. [`\hyphenation`](#hyphenation-1)
      1. [Hyphenation Algorithm](#hyphenation-algorithm)
      1. [`\patterns`](#patterns)
   1. [Making Paragraphs](#making-paragraphs)
   1. [Line Breaking Parameters Summary](#line-breaking-parameters-summary)
   1. [Making Pages](#making-pages)
      1. [`\shipout`](#shipout)
      1. [`\vsplit`](#vsplit)
   1. [`\special`](#special)
   1. [Main Processor's Registers and Primitives](#main-processors-registers-and-primitives)
      ...
      1. [Fonts](#fonts-1)
      1. [Grouping](#grouping)
      1. [Horizontal Contributions](#horizontal-contributions)
      1. [Math Contributions](#math-contributions)
         1. [Fonts](#fonts-2)
         1. [Fractions](#fractions)
         1. [Matrices](#matrices)
      1. [Miscellaneous](#miscellaneous)
      1. [Page](#page)
      1. [Parameters and Registers](#parameters-and-registers)
         1. [Alignment](#alignment-1)
         1. [Auxiliary Storage](#auxiliary-storage)
         1. [Boxes](#boxes-2)
         1. [Codes](#codes)
         1. [Debugging](#debugging-1)
         1. [Definitions](#definitions-1)
         1. [Error Management](#error-management-1)
         1. [Floats](#floats-1)
         1. [Fonts](#fonts-3)
         1. [Horizontal Contributions](#horizontal-contributions-1)
         1. [Horizontal Spaces](#horizontal-spaces)
         1. [Input Processor](#input-processor-1)
         1. [Math Contributions](#math-contributions-1)
         1. [Math Spaces](#math-spaces)
         1. [Miscellaneous](#miscellaneous-1)
         1. [Page](#page-1)
         1. [Time](#time)
         1. [Vertical Contributions](#vertical-contributions)
         1. [Vertical Spaces](#vertical-spaces)
      1. [Vertical Contributions](#vertical-contributions-1)
1. [Terminology and Syntax Rules](#terminology-and-syntax-rules)
